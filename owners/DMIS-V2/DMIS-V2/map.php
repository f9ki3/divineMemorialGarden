...
<head>
    ...
    <input type="text" id="searchbar" placeholder="Search lot number...">
    ...
    <link rel="stylesheet" href="mapping_style_y.css">
    ...
    <div id="popup1" class="popup-container">
      ...
      <div id="popup2" class="popup-container">
        <div class="popup-content">
          ...
          <img class="img" src="location.png" alt="location">
          <h2 class="name">Jaybe Contreras</h2>
          <h5 class="date">June 9. 1985 - July 29. 2020</h5>
      ...
      <div id="popup4" class="popup-container">
        <div class="popup-content">
         ...
         <div >
          <h5 class="prodeuct_de">Product Deatail</h5>
      ...
      <div class="status1">
        <div class="status2"><p></p></div>
        <div class="status3"><p>RESALE</p></div>
        <div class="status4"></div>
        <div class="status3"><p>OWNED</p></div>
    </div>
    <div class="zero">
