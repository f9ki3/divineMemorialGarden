...
<body class="body">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#009B4D">
        <div class="container">
            ...
            <ul class="navbar-nav">
                <li class="nav-link">
                    <a href="index.php" class="btn btn-success shadow-sm ms-auto">Login</a>
                    <a href="index.html" class="btn btn-success shadow-sm ms-auto">Back</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container border body-content shadow-sm">
        <div class="p-4 mb-3">
            <div class="h5 mb-4">Create New Account</div>
