<?php
    ...
    $salon = $db->row('admin', "user_id=$user_id");
?>
    ...
    <div class="container bg-white shadow p-4 mb-5">
        ...
        <div class="row mt-4">
            <div class="col-sm-12">
                ...
                <div class="p-2">
                    <input type="hidden" id="user_id" value="<?= $salon->user_id; ?>" />
                        <div class="form-floating mb-3">
                            <input type="text" name="name" class="form-control" id="name" value="<?= $salon->account_name; ?>" />
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" name="username" class="form-control" id="username" value="<?= $salon->username; ?>" />
                            <label for="floatingInput">User Name <span class="text-danger">*</span></label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" name="password" class="form-control" id="password" value="<?= $salon->password; ?>" />
                            <label for="floatingInput">Password <span class="text-danger">*</span></label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="password" name="confirm_password" class="form-control" id="confirm_password" value="<?= $salon->password; ?>" />
    ...
    <script>
        $(function() {
             ...
             $('#saveUser').click(function() {
                ...
                const makeInsert = insertData('user-update.php', {
                    user_id, name, user_type, username, password, submitted: true
                });
