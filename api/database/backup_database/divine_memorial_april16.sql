...
(9, NULL, 'Lawn 1', '1', 'N', 'Regular', 'RODOLFO CONCEPCION 1', 0, 'block1lotN.png'),
...
CREATE TABLE `sell_bulletin` (
  ...
  `bulletin_sell_start` double NOT NULL,
  `bulletin_sell_end` double NOT NULL,
  `bulletin_coo` varchar(100) NOT NULL,
  `bulletin_investment_form` varchar(100) NOT NULL,
...
INSERT INTO `users` (`id`, `user_property_id`, `user_date_added`, `user_fname`, `user_lname`, `user_email`, `user_contact`, `user_address`, `user_barangay`, `user_municipal`, `user_province`, `user_zipcode`, `user_profile`, `user_name`, `user_password`, `user_type`, `user_status`, `user_otp`, `user_otp_status`) VALUES
(1, 0, '2024-04-03 17:38:47', 'Dave', 'Bergania', 'dave@gmail.com', '09120912098', '-', '', '', '', 0, 'dave_profile.jpg', 'dave', '61ea0803f8853523b777d414ace3130cd4d3f92de2cd7ff8695c337d79c2eeee', 0, 0, 0, 1),
(2, 0, '2024-04-03 17:42:24', 'Stephany', 'Gandula', 'steph@gmail.com', '09120912919', 'Karla Ville,', 'Prenza II', 'Marilao', 'Bulacan', 0, 'stephany_profile.jpg', 'stephany', '0867483ba62a2b8786ba79c6ccf6ba8fd2c01cb8fdc022ffe00d2235d17ffb8d', 1, 0, 0, 1),
(43, 0, '0000-00-00 00:00:00', NULL, NULL, 'floterina@gmail.com', NULL, NULL, '', '', '', 0, 'profile_dummy.jpg', '', '1d70d2e104d23fb48a0675de436716290ac4128e164fec133a7d36d9ad6500c8', 2, 0, 3866, 1);
...
--
-- Constraints for table `sell_bulletin`
--
ALTER TABLE `sell_bulletin`
  ADD CONSTRAINT `sell_bulletin_ibfk_1` FOREIGN KEY (`bulletin_user_id`) REFERENCES `users` (`id`);
