...
$(document).ready(function() {
    // Function to initialize and reload the DataTable
    function initializeDataTable() {
        var table = $('#client').DataTable({
            "ajax": {
                "url": "../php/fetch_account_admin.php",
                "dataSrc": ""
            },
            "columns": [
                { 
        ...
        // Set interval to reload DataTable data every 30 seconds (adjust as needed)
        setInterval(function() {
            table.ajax.reload(null, false); // Reload data without resetting current page
        }, 30000); // 30 seconds interval (30000 milliseconds)
    }

    // Call initializeDataTable to start the DataTable and interval
    initializeDataTable();
});
