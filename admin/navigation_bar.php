    ...
    <nav class="container d-flex py-3 justify-content-between">
        ...
        <div class="d-flex">
            <div class="d-flex mt-2 d-flex justify-content-between">
                ...
                <li><a href="burial" class="text-light mx-3" style="text-decoration: none;">Transaction</a></li>
                ...
                <li><a href="maintenance" class="text-light mx-3" style="text-decoration: none;">Maintenance</a></li>
            </div>
            <div class="btn-group">
