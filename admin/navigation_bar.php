<div class="bg-success sticky-top">
    <nav class="container d-flex py-4 justify-content-between">
        <div>
            <h3 class="fw-bolder text-light">Divine Garden Memorial</h3>
        </div>
        <div class="d-flex">
            ...
            <li><a href="logout" class="text-light mx-3" style="text-decoration: none;">Logout</a></li>
        </div>
    </nav>
</div>
