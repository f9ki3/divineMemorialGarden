...
$sql = "SELECT deceased_name, dob, dod, grave_status FROM deceased_person WHERE property_id = $id AND deceased_type = 'upper'";
...
<script>
function submit_upper() {
    // Collect values from input fields
    var upperName = $('#upper_name').val();
    var deceasedStatus = $('#deceased_status').val();
    var dod = $('#dod').val();
    var dob = $('#dob').val();
